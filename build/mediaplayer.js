...
var settingSideBar = document.getElementById("mediaSettingSidebar");
var index = 0;
function MediaPlayer(_ref) {
  var _ref$settingsPosition = _ref.settingsPosition,
    settingsPosition = _ref$settingsPosition === void 0 ? "top-right" : _ref$settingsPosition,
    settingsValues = _ref.settingsValues,
    _ref$playControlPosit = _ref.playControlPosition,
    ...
    _ref$playerEdges = _ref.playerEdges,
    playerEdges = _ref$playerEdges === void 0 ? "flat" : _ref$playerEdges,
    ...
    titleSize = _ref$titleSize === void 0 ? 20 : _ref$titleSize,
    ...
    imgWidth = _ref$imgWidth === void 0 ? 80 : _ref$imgWidth,
    _ref$imgHeight = _ref.imgHeight,
    imgHeight = _ref$imgHeight === void 0 ? 80 : _ref$imgHeight,
  ...
  if (theme === "advance") {
    advanceTheme(buttonColor, mediaContainer, howlPlayer, img, title, titleColor, titleSize, playControlPosition, playControlValues, otherControlPosition, otherControlValues, mediaSeekPosition, mediaSeekValues, imgWidth, imgHeight, editable);
  } else {
  ...
  var setttingPosition = getPosition(settingsPosition, settingsValues);
  mediaSetting.style.position = "absolute";
  Object.keys(setttingPosition).forEach(function (key) {
    return mediaSetting.style[key] = setttingPosition[key];
  });
  var mediaSideBar = document.createElement("div");
  ...
  if (editable && theme === "advance") {
    ...
    var mediaSideBarContent = document.createElement("div");
    mediaSideBarContent.classList.add("sidebarContent");
    mediaSideBarContent.id = "sidebarContent";
    var closeSidebarBtn = document.createElement("div");
...
var advanceTheme = function advanceTheme(buttonColor, mediaContainer, howlPlayer, img, titleValue, titleColor, titleSize, playControlPosition, playControlValues, otherControlPosition, otherControlValues, mediaSeekPosition, mediaSeekValues, imgWidth, imgHeight, editable) {
  //  console.log("adv");
  mediaContainer.innerHTML = "";
